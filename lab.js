...
const cat1 = new Cat("Mose", 5, "black/white")
console.log(cat1)
//////////////////////////// PROBLEM 13 ////////////////////////////
/*
...
//Code here
class Wizard {
  constructor (wizardName, age, favoriteSpell){
    this.wizardName = wizardName
    this.age = age
    this.favoriteSpell = favoriteSpell
  }
  castSpell(){
    console.log(`${this.wizardName} has cast ${this.favoriteSpell}`)
  }
}
let wizard1 = new Wizard("Ron", 20, "Stupify")
wizard1.castSpell()
//////////////////////////// PROBLEM 14 ////////////////////////////
/*
...
let phone1 = new Phone ("Apple", "iPhone 12", 64, "Black", 900)
let phone2 = new Phone ("Samsung", "Galaxy", 128, "White", 800)
let phone3 = new Phone ("Motorola", "Razr", 16, "Black", 100)
...
let myFirstVehicle = new Vehicle(5, "White", 60000)
...
let myFirstMotorcycle = new Motorcycle(2, "Black", 10000, "Yamaha")
...
let myFirstBoat = new Boat(10, "blue", 5000, "'Ole Betsy'", "boat")
